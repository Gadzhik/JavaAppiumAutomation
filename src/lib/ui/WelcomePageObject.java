...
public class WelcomePageObject extends MainPageObject
{
    ...
    {
        this.waitForElementPresent(STEP_NEW_WAYS_TO_EXPLORE_TEXT, "Cannot find 'New way to explore' link", 10);
    }
    ...
    {
        this.waitForElementAndClick(SKIP, "Canno find and click 'SKIP' button", 5);
    }
}
